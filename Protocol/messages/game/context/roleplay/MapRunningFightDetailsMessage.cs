...
namespace BlueSheep.Protocol.Messages.Game.Context.Roleplay
{
    ...
    public class MapRunningFightDetailsMessage : Message
    {
        ...
        protected override int ProtocolId { get; set; } = 5751;
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            {
                GameFightFighterLightInformations objectToAdd = ProtocolTypeManager.GetInstance<GameFightFighterLightInformations>(reader.ReadUShort());
