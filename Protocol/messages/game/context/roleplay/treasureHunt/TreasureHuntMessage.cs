...
namespace BlueSheep.Protocol.Messages.Game.Context.Roleplay.TreasureHunt
{
    ...
    public class TreasureHuntMessage : Message
    {
        ...
        protected override int ProtocolId { get; set; } = 6486;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            writer.WriteVarInt(m_checkPointCurrent);
            writer.WriteVarInt(m_checkPointTotal);
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            {
                TreasureHuntStep objectToAdd = ProtocolTypeManager.GetInstance<TreasureHuntStep>(reader.ReadUShort());
