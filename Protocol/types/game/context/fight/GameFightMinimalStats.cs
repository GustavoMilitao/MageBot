...
namespace BlueSheep.Protocol.Types.Game.Context.Fight
{
    ...
    public class GameFightMinimalStats : NetworkType
    {
        ...
        protected override int ProtocolId { get; set; } = 31;
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            writer.WriteVarInt(m_baseMaxLifePoints);
            writer.WriteVarInt(m_permanentDamagePercent);
            writer.WriteVarInt(m_shieldPoints);
            ...
            writer.WriteVarShort(m_dodgePALostProbability);
            writer.WriteVarShort(m_dodgePMLostProbability);
            ...
            writer.WriteVarShort(m_meleeDamageReceivedPercent);
            writer.WriteVarShort(m_rangedDamageReceivedPercent);
            writer.WriteVarShort(m_weaponDamageReceivedPercent);
            writer.WriteVarShort(m_spellDamageReceivedPercent);
        }
