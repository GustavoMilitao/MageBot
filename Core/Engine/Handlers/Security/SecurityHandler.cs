...
namespace BlueSheep.Engine.Handlers.Security
{
    class SecurityHandler
    {
        ...
        public static void RawDataMessageTreatment(Message message, byte[] packetDatas, Account account)
        {
        ...
        public static void CheckIntegrityMessageTreatment(Message message, byte[] packetDatas, Account account)
        {
        }
