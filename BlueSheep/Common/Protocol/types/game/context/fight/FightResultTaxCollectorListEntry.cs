...
namespace BlueSheep.Common.Protocol.Types
{
    ...
    public class FightResultTaxCollectorListEntry : FightResultFighterListEntry
    {
        ...
        public FightResultTaxCollectorListEntry(int outcome, sbyte wave, Types.FightLoot rewards, ulong id, bool alive, byte level, Types.BasicGuildInformations guildInfo, int experienceForGuild)
