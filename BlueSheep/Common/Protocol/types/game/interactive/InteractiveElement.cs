...
namespace BlueSheep.Common.Protocol.Types
{
    ...
    public class InteractiveElement
    {
        ...
        public virtual void Deserialize(BigEndianReader reader)
        {
            ...
            {
                enabledSkills[i] = Types.ProtocolTypeManager.GetInstance<InteractiveElementSkill>(reader.ReadUShort());
            ...
            for (int i = 0; i < limit; i++)
            {
                disabledSkills[i] = Types.ProtocolTypeManager.GetInstance<InteractiveElementSkill>(reader.ReadUShort());
