...
namespace BlueSheep.Common.Protocol.Types
{
    public class PaddockInstancesInformations : PaddockInformations
    {
        ...
        public virtual void Serialize(BigEndianWriter writer)
        {
            ...
            writer.WriteShort((short)(int)paddocks.Count);
            uint _loc2_ = 0;
            while (_loc2_ < paddocks.Count)
            {
                writer.WriteShort((short)(paddocks[(int)_loc2_] as PaddockBuyableInformations).TypeId);
        ...
        public virtual void Deserialize(BigEndianReader reader)
        {
            ...
            while (_loc3_ < _loc2_)
            {
                ...
                _loc5_ = ProtocolTypeManager.GetInstance<PaddockBuyableInformations>((int)_loc4_);
