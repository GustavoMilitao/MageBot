package com.ankamagames.dofus.network.types.game.house
{
   ...
   public class HouseGuildedInformations extends HouseInstanceInformations implements INetworkType
   {
      ...
      public function initHouseGuildedInformations(param1:uint = 0, param2:Boolean = false, param3:String = "", param4:Boolean = false, param5:Boolean = false, param6:GuildInformations = null) : HouseGuildedInformations
      {
         super.initHouseInstanceInformations(param1,param2,param3,param4,param5);
