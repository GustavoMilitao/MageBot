package com.ankamagames.dofus.network.types.game.house
{
   ...
   public class HouseInstanceInformations implements INetworkType
   {
      ...
      public function initHouseInstanceInformations(param1:uint = 0, param2:Boolean = false, param3:String = "", param4:Boolean = false, param5:Boolean = false) : HouseInstanceInformations
      {
      ...
      private function deserializeByteBoxes(param1:ICustomDataInput) : void
      {
         ...
         this.isOnSale = BooleanByteWrapper.getFlag(_loc2_,1);
