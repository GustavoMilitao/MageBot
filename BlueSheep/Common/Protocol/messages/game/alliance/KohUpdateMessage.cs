...
namespace BlueSheep.Common.Protocol.Messages.Game.Alliance
{
 	 ...
 	 public class KohUpdateMessage : Message 
    {
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            {
                writer.WriteVarShort(m_allianceNbMembers[allianceNbMembersIndex]);
            }
            ...
            {
                writer.WriteVarInt(m_allianceRoundWeigth[allianceRoundWeigthIndex]);
            }
            ...
            writer.WriteVarInt(m_allianceMapWinnerScore);
            writer.WriteVarInt(m_allianceMapMyAllianceScore);
