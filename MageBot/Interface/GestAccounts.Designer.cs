...
namespace MageBot.Interface
 {
     partial class GestAccounts
     {
         ...
         private void InitializeComponent()
         {
            ...
            this.IsMITM = new MageBot.Interface.SadikCheckbox();
            this.DelBt = new MageBot.Interface.SadikButton();
            this.listViewAccounts = new System.Windows.Forms.ListView();
            this.LaunchAccountsSelecBt = new MageBot.Interface.SadikButton();
            ...
            this.IsMITM.CheckedChanged += new MageBot.Interface.SadikCheckbox.CheckedChangedEventHandler(this.IsMITM_CheckedChanged);
            // 
            // DelBt
            // 
            ...
            // 
            this.LaunchAccountsSelecBt.ButtonStyle = MageBot.Interface.SadikButton.Style.Blue;
