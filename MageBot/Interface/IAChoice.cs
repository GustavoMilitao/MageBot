...
namespace MageBot.Interface
{
    public partial class IAChoice : MetroFramework.Forms.MetroForm
    {
        ...
        private void AddBt_Click(object sender, EventArgs e)
        {
            ...
            {
                string combinedPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "MageBot", "IAs", openFileDialog1.SafeFileName);
        ...
        private void Init()
        {
            string combinedPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "MageBot", "IAs");
